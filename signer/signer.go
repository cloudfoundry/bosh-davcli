...
func (s *signer) GenerateSignedURL(blobstorePath, objectID, verb string, timeStamp time.Time, expiration int64) (string, error) {
	...
	invalidAfter := timeStamp.Add(time.Second * time.Duration(expiration))
